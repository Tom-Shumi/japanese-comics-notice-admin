javascript:(()=>{navigator.clipboard.writeText(document.getElementById('detailBulletsWrapper_feature_div').querySelector('li:nth-child(1)').firstElementChild.lastElementChild.textContent.trim()).then(()=>console.log("")).catch(e=>alert('エラー！ '+e.message));})();
javascript:(()=>{navigator.clipboard.writeText(document.getElementById('detailBulletsWrapper_feature_div').querySelector('li:nth-child(3)').firstElementChild.lastElementChild.textContent.trim()).then(()=>console.log("")).catch(e=>alert('エラー！ '+e.message));})();
